...
function SwitchButton(props) {
    ...
    return (react_1.default.createElement(material_1.Switch, { disabled: props.disabled, checked: props.checked, sx: Object.assign({}, classes), color: props.color, onChange: props.onChange }));
